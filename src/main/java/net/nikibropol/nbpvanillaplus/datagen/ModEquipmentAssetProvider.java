...
public class ModEquipmentAssetProvider implements DataProvider {
    ...
    private static void bootstrap(BiConsumer<ResourceKey<EquipmentAsset>, EquipmentClientInfo> consumer){
        consumer.accept(ModArmorMaterials.ECHO_KEY,
                EquipmentClientInfo.builder()
                        .addHumanoidLayers(Identifier.fromNamespaceAndPath(NBPVanillaPlus.MOD_ID, "echo"))
                        .addLayers(EquipmentClientInfo.LayerType.HORSE_BODY,
                                new EquipmentClientInfo.Layer(Identifier.fromNamespaceAndPath(NBPVanillaPlus.MOD_ID, "echo")))
    ...
    public String getName() {
        return "NikiBroPol Vanilla Plus Equipment Asset Definition";
    }
}
